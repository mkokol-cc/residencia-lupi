...
var NgxCurrencyDirective = class _NgxCurrencyDirective {
  ...
  ngOnInit() {
    this._inputHandler = new InputHandler(this._elementRef.nativeElement, __spreadValues(__spreadValues({}, this._optionsTemplate), this.options));
  }
  ngAfterViewInit() {
  ...
  ngDoCheck() {
    if (this._keyValueDiffer.diff(this.options)) {
      this._elementRef.nativeElement.style.textAlign = this.options?.align ?? this._optionsTemplate.align;
      this._inputHandler.updateOptions(__spreadValues(__spreadValues({}, this._optionsTemplate), this.options));
    }
  }
  handleBlur(event) {
  ...
  static {
    this.ɵfac = function NgxCurrencyDirective_Factory(t) {
      return new (t || _NgxCurrencyDirective)(ɵɵdirectiveInject(NGX_CURRENCY_CONFIG, 8), ɵɵdirectiveInject(KeyValueDiffers), ɵɵdirectiveInject(ElementRef));
    };
  }
  static {
